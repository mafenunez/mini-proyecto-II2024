...
canciones_2010 <- read.csv2("../mini-proyecto-II2024/input/data/canciones2010.csv", encoding = "utf-8")
canciones_1960 <- read.csv2("../mini-proyecto-II2024/input/data/canciones1960.csv", encoding = "utf-8")
